			...
			<div className={'flex flex-col-reverse md:flex-row items-center justify-between'}>
				<div className={'flex flex-1 flex-col gap-4'}>
					<div className={'flex flex-col md:flex-row items-center mt-4 md:mt-0'}>
						<span
							className={`text-2xl font-bold bg-teal-200 text-sky-950 rounded-full md:rounded-l-full md:rounded-r-none whitespace-nowrap py-2 px-4 md:pl-6 md:pr-2`}
						>
							Unlock Your Potential
						</span>
						<span
							className={`text-lg md:text-2xl font-bold bg-red-400 text-neutral-50 rounded-b-3xl md:rounded-r-full whitespace-nowrap px-4 py-2 md:pr-6 md:pl-2`}
						>
							Never Forget Again
						</span>
					</div>
